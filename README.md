...
|  SMALLBANK偏斜度为0.8（没有读）   |  smallbank偏斜度0.2    | 偏斜度0.4      |偏斜度0.6     |  偏斜度0.8   | 偏斜度1      |
| -------- | -------- | -------- | -------- |-------- |-------- |
| 吞吐量434.0 | 227.0 | 269.4 | 2.94s | 2.45s | 3.93s |
| 延迟0.03s |   | 213.3 | 1.18s | 2.43s | 2.51s |
| CPU使用率14.11% | 274.4 | 173.6 | 2.32s | 3.02s | 0.59s |
| 内存使用率1.55 | 255.6 | 272.2 | 0.67s | 3.58s | 2.42s |
load 184.5、0.18s|  | 246.2 | 1.66s | 3.41s | 3.06s |
mixed 434.0、0.18s| 245.3 | 246.2 | 1.66s | 3.41s | 3.06s |
